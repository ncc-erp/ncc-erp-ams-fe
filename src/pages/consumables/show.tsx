...
export const ConsumablesShow = (props: ConsumablesShowProps) => {
    ...
    return (
        <>
            ...
            <Row gutter={16}>
                <Col className="gutter-row" span={6}>
                    <Title level={5}>{translate("consumables.label.field.category")}</Title>
                </Col>
                <Col span={18}>
                    {detail?.category ? (
            ...
            <Row gutter={16}>
                <Col className="gutter-row" span={6}>
                    <Title level={5}>{translate("consumables.label.field.location")}</Title>
                </Col>
                <Col span={18}>
                    {detail?.location ? (
                        <Text className="show-asset">
            ...
            <Row gutter={16}>
                <Col className="gutter-row" span={6}>
                    <Title level={5}>{translate("consumables.label.field.manufacturer")}</Title>
                </Col>
                <Col>
                    {detail?.manufacturer ? (
                        <>
            ...
            <Row gutter={16}>
                <Col className="gutter-row" span={6}>
                    <Title level={5}>{translate("consumables.label.field.supplier")}</Title>
                </Col>
                <Col span={18}>
                    {detail?.supplier ? (
                        <>
            ...
            <Row gutter={16}>
                <Col className="gutter-row" span={6}>
                    <Title level={5}>{translate("consumables.label.field.purchase_cost")}</Title>
                </Col>
                <Col>
            ...
            <Row gutter={16}>
                <Col className="gutter-row" span={6}>
                    <Title level={5}>{translate("consumables.label.field.purchase_date")}</Title>
                </Col>
                <Col>
                    <Text>{detail?.purchase_date && detail?.purchase_date.formatted}</Text>
                </Col>
            </Row>
            <Row gutter={16}>
                <Col className="gutter-row" span={6}>
                    <Title level={5}>{translate("consumables.label.field.insurance")}</Title>
                </Col>
                <Col span={18}>
                    <Text>
                        {detail?.warranty_months}{" months"}
                    </Text>
                </Col>
            </Row>
            <Row gutter={16}>
            ...
            <Row gutter={16}>
                <Col className="gutter-row" span={6}>
                    <Title level={5}>{translate("consumables.label.field.created_at")}</Title>
                </Col>
                <Col span={18}>
                    {detail?.created_at ? (
            ...
            <Row gutter={16}>
                <Col className="gutter-row" span={6}>
                    <Title level={5}>{translate("consumables.label.field.updated_at")}</Title>
                </Col>
                <Col span={18}>
            ...
            <Row gutter={16}>
                <Col className="gutter-row" span={6}>
                    <Title level={5}>{translate("consumables.label.field.remaining")}</Title>
                </Col>
                <Col span={18}>
