...
export const AccessoryShow = (props: AccessoryShowProps) => {
    ...
    return (
        <>
            ...
            <Row gutter={16}>
                <Col className="gutter-row" span={6}>
                    <Title level={5}>{translate("accessory.label.field.manufacturer")}</Title>
                </Col>
                <Col>
                    {detail?.manufacturer ? (
                        <>
            ...
            <Row gutter={16}>
                <Col className="gutter-row" span={6}>
                    <Title level={5}>{translate("accessory.label.field.purchase_cost")}</Title>
                </Col>
                <Col>
            ...
            <Row gutter={16}>
                <Col className="gutter-row" span={6}>
                    <Title level={5}>{translate("accessory.label.field.purchase_date")}</Title>
                </Col>
                <Col>
            ...
            <Row gutter={16}>
                <Col className="gutter-row" span={6}>
                    <Title level={5}>{translate("accessory.label.field.insurance")}</Title>
                </Col>
                <Col span={18}>
                    <Text>
            ...
            <Row gutter={16}>
                <Col className="gutter-row" span={6}>
                    <Title level={5}>{translate("accessory.label.field.created_at")}</Title>
                </Col>
                <Col span={18}>
                    {detail?.created_at ? (
            ...
            <Row gutter={16}>
                <Col className="gutter-row" span={6}>
                    <Title level={5}>{translate("accessory.label.field.updated_at")}</Title>
                </Col>
                <Col span={18}>
            ...
            <Row gutter={16}>
                <Col className="gutter-row" span={6}>
                    <Title level={5}>{translate("accessory.label.field.remaining_qty")}</Title>
                </Col>
                <Col span={18}>
