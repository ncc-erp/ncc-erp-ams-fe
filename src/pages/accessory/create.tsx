...
export const AccessoryCreate = (props: AccessoryCreateProps) => {
    ...
    const onFinish = (event: IAccesstoryRequest) => {
        ...
        if (event.qty !== undefined) { formData.append("qty", event.qty.toString()); }
        if (event.supplier !== undefined) formData.append("supplier_id", event.supplier);
        ...
        >
            <Row gutter={16}>
                <Col className="gutter-row" span={12}>
                    ...
                    {messageErr?.supplier && (
                        <Typography.Text type="danger">{messageErr.supplier}</Typography.Text>
                    )}
                </Col>
                ...
                <Col className="gutter-row" span={12}>
                    ...
                    {messageErr?.location && (
                        <Typography.Text type="danger">{messageErr.location}</Typography.Text>
                    )}
