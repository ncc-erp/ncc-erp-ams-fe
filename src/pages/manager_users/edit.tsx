...
export const UserEdit = (props: UserCreateProps) => {
  ...
  const [permissionsAdmin, setPermissionsAdmin] = useState(
    props?.data?.permissions && props?.data?.permissions.admin
  );
  const [permissionsSuperUser, setPermissionsSuperUser] = useState(
    props?.data?.permissions && props.data?.permissions.superuser
  );
    ...
    setFields([
      ...
      { name: "avatar", value: data?.avatar },
      {
        ...
        value: [
          {
            name: "admin",
            value: data?.permissions ? data?.permissions.admin : "",
          },
          {
            name: "superuser",
            value: data?.permissions ? data?.permissions.superuser : "",
          },
        ],
      },
    ]);
