...
export const HardwareEdit = (props: HardwareEditProps) => {
  ...
  useEffect(() => {
    setFields([
      ...
      { name: "supplier_id", value: data.supplier },
    ...
    >
      <Row gutter={16}>
        <Col className="gutter-row" span={12}>
          ...
          >
            <Input defaultValue={data?.asset_tag} value={data?.asset_tag} />
          </Form.Item>
