export const GETME_API = "api/v1/hardware/me";
...
export const SUPPLIERS_HARDWARE_API = "api/v1/suppliers";
export const COMPANIES_API = "api/v1/companies";
export const HARDWARE_SELECTLIST_API = "api/v1/hardware/selectlist";
