...
jest.mock("pages/hardware/list-pending", () => ({
  HardwareListPending: MockHardwareListPending,
}));

describe("HardwareListPending page", () => {
  let HardwareListPending: React.FC;
  beforeEach(() => {
    jest.clearAllMocks();
    mockLocalStorage.clear();
    // require the component AFTER mocks are in place
    // eslint-disable-next-line @typescript-eslint/no-var-requires
    HardwareListPending =
      require("pages/hardware/list-pending").HardwareListPending;
  });

  describe("Check render", () => {
    it("renders list title and header actions", () => {
      render(<HardwareListPending />);
  ...
  describe("Basic workflows", () => {
    ...
    it("opens show modal when show button clicked", async () => {
      render(<HardwareListPending />);
    ...
    it("opens clone modal when clone button clicked", async () => {
      render(<HardwareListPending />);
      const row = screen.getByTestId("table-row-1");
    ...
    it("opens checkout and checkin modals when respective buttons clicked", async () => {
      render(<HardwareListPending />);
      const row = screen.getByTestId("table-row-1");
    ...
    it("persists column selection when columns button is clicked", async () => {
      render(<HardwareListPending />);
